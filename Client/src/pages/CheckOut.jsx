            ...
            <div className="sticky-top" style={{ top: '2rem' }}>
              <div className="card shadow-sm border-0 mb-4">
                <div className="card-body">
                  ...
                  {userDetails ? <Coupon setDiscount={setDiscount} setDiscountCode={setDiscountCode} userId={userDetails} subtotal={subtotal} /> : <Link to={'/login'} className='text-decoration-none text-dark'><Coupon setDiscount={setDiscount} setDiscountCode={setDiscountCode} userId={userDetails} subtotal={subtotal} /></Link>}
