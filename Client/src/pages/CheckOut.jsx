...
function CheckOut() {
  ...
  const handlePayment = () => {
    const options = {
      ...
      // amount: parseInt(subtotal < 299 ? subtotal + 79 : subtotal) * 100, 
            ...
            <div className="card mb-4">
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between mb-3">
                  ...
                  <span>{subtotal- ((subtotal*discount)/100)   < 299 ? '₹79' : 'Free'}</span>
                </div>
                <div className="d-flex justify-content-between">
                  <h5>Total</h5>
                  {/* <h5>₹{subtotal < 299 ? subtotal + 79 : subtotal}</h5> */}
                  <h5>₹{subtotal - ((subtotal*discount)/100)  < 299 ? subtotal - ((subtotal*discount)/100)  + 79 : subtotal - ((subtotal*discount)/100) }</h5>
                </div>
                <div className="mt-3">
