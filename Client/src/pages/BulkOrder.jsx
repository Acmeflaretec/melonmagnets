...
function BulkOrder() {
  ...
  const handleSubmit = async(e) => {
    ...
    if (!formData.mobile.trim() || !isValidPhoneNumber(formData.mobile.trim())) {
      errors.mobile = 'Valid mobile number is required'; // Changed from 'phone' to 'mobile'
      isValid = false;
    }

    if (!formData.quantity.trim() || isNaN(formData.quantity) || parseInt(formData.quantity) < 10) {
    ...
    <div>
      <div className="container mt-5 bulk-order-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label htmlFor="mobile" className="form-label">Mobile Number</label> {/* Changed from 'phone' to 'mobile' */}
            <input 
              type="tel" 
          ...
          <div className="mb-3">
            <label htmlFor="quantity" className="form-label">Quantity (minimum 10)</label>
            <input 
              type="number" 
